...
const CoinsHeaderIcon = (props: ICoinsHeaderIcon) => {
    return <div
        className={'flex pl-3 pr-3 pt-3 align-middle mb-[5px] gap-[8px] border-[1px] rounded-full border-neutral-200 border-solid'}>
...
export const Header = () => {
    ...
    return <div className={'flex flex-col justify-center pt-[36px] pb-[36px] pl-[7%] pr-[7%]'}>
        <div className={'flex'}>
            ...
            <FormProvider {...fm}>
                <Input name={'search'} colorScheme={'gray'} contentClassName={'ml-[28%] w-[23%]'}
